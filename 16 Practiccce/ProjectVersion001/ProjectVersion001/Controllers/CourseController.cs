...
namespace ProjectVersion001.Controllers
{
    public class CourseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseId,Code,Name,Credit,Description,SemisterId,DepartmentId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseId,Code,Name,Credit,Description,SemisterId,DepartmentId")] Course course)
        {
            if (ModelState.IsValid)
            {
